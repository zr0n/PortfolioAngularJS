...
class CategoriesService {
  ...
  private makeJobs() : Job[]{
    ...
    job0.setupWithVideo(
      "Dungeon Crownley",
      "Um incrível jogo multiplayer online, que bebeu na fonte de jogos como Skyrim. Nesse jogo fui responsável por trabalhar com módulos multijogador entre outros elementos relacionados com a mecânica principal do jogo. O jogo foi produzido pela empresa Animvs.",
    ...
    job1.setupWithVideo(
      "Scarcity",
      "um incrível jogo FPS multijogador online. Nesse projeto fui responsável por construir a inteligência artificial dos bots presentes no jogo. Também lidei com a implementação de outras features além de analisar e melhorar a performance geral do jogo. Esse jogo foi produzido pela empresa Exceedreams.",
      [Category.CPP, Category.Unreal],
    ...
    job2.setupWithImage(
      "Churroz Game Engine",
      "Fiz essa engine para estudar mais sobre os pormenores da biblioteca DirectX 11. É de longe um projeto profissional, porém me gerou muito aprendizado e enfrentei diversos desafios ao fazê-lo. https://github.com/zr0n/churroz",
      [Category.C],
    ...
    job3.setupWithImage(
      ...
      "Uma extensão para limpar vídeos do youtube. Utilizei javascript e a api do firefox para desenvolver tal. https://github.com/zr0n/ClearWatchLaterVideos",
      [Category.Javascript],
    ...
    job5.setupWithImage(
      "Laboratório ESPM",
      "Aplicativo que envolve gamification desenvolvido para a ESPM. Tive a oportunidade de trabalhar com recursos de html 5 para gerar um aplicativo em formato de games para um projeto da ESPM.",
      [Category.Javascript],
    ...
    job6.setupWithImage(
      "App Forca LF",
      "Esse aplicativo foi feito utilizando apenas um editor java para smartphone. Foi um desafio que eu me fiz (desenvolver um aplicativo sem utilizar um computador e utilizando a linguagem java)",
      [Category.Java],
    ...
    job7.setupWithImage(
      "Joyful Mouse",
      "Controle o cursor do windows utilizando um joystick https://github.com/zr0n/JoyfulMouse. Nesse projeto tive a oportunidade de explorar a api do windows para criar um controlador de cursor utilizando o joystick, permitindo controlar o computador a distância.",
      [Category.C],
    ...
    job8.setupWithImage(
      "Joystickz",
      "Plugin que permite usar joysticks genéricos no Unreal Engine 4. Nativamente a Unreal não permite que joysticks genéricos sejam usados. Nesse projeto explorei a api do windows para poder dar suporte ao driver genérico. https://github.com/zr0n/Joyztick",
      [Category.C],
    ...
    job12.setupWithImage(
      "Widget To Texture",
      "Um plugin que renderiza widgets UMG em texturas. Com isso você pode ter uma interface interativa em um objeto 3D no seu mundo. Uso isso até hoje em meus projetos, bem útil.",
    ...
    job16.setupWithVideo(
      "UR01",
      "Jogo desenvolvido para a Two Colors Game Jam. Como o nome sugere, só podíamos usar até 2 cores em toda a paleta do jogo. Além disso o jogo conta com um mapa infinito gerado proceduralmente. Criar esse mapa foi um desafio muito gostoso de resolver.",
      [Category.C, Category.CPP, Category.Unreal],
    ...
    job17.setupWithImage(
      "Hungry Birds",
      "Esse jogo é uma paródia de angry birds. Você deve alimentar os passos famintos com as cores corretas. Jogo criado para uma game jam. Foi ótimo pois aprendi bastante com meu time, e o pouco tempo que tivemos para desenvolver nos ensinou muito. Jogue pelo browser: https://luizfernando.itch.io/hungry-birds",
